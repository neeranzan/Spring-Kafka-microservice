...
import com.mes.consumer.configuration.KafkaTestConfig;
...
@Slf4j
@EmbeddedKafka(partitions = 1, topics = {"merchant_topic"}, brokerProperties = {"listeners=PLAINTEXT://localhost:19092", "port=19092"})
@DirtiesContext(classMode = DirtiesContext.ClassMode.AFTER_CLASS)
@TestPropertySource(locations = {"classpath:application-integrationTestingDbContainer.properties"})
@ActiveProfiles("test")
...
public class ProfileListenerDBContainerTest {
